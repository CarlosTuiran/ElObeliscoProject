...
@Component({
  ...
  templateUrl: './top-empleados-pie-chart.component.html',
  styleUrls: ['./top-empleados-pie-chart.component.css']
})
export class TopEmpleadosPieChartComponent implements OnInit {
