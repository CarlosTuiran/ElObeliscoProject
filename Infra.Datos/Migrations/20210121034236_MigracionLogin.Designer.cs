...
namespace Infra.Datos.Migrations
{
    ...
    [Migration("20210121034236_MigracionLogin")]
            ...
            modelBuilder.Entity("Domain.Models.Entities.DFactura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Bodega = "BD1",
                            Cantidad = 5,
                            FechaFactura = new DateTime(2021, 1, 20, 22, 42, 35, 450, DateTimeKind.Local).AddTicks(4800),
                            MfacturaId = 1,
                            PrecioTotal = 0.0,
            ...
            modelBuilder.Entity("Domain.Models.Entities.MFactura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaFactura = new DateTime(2021, 1, 20, 22, 42, 35, 449, DateTimeKind.Local).AddTicks(8094),
                            FechaPago = new DateTime(2021, 1, 20, 22, 42, 35, 449, DateTimeKind.Local).AddTicks(9841),
            ...
            modelBuilder.Entity("Domain.Models.Entities.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fabrica = "Ferres SAS",
                            FechaRegistro = new DateTime(2021, 1, 20, 22, 42, 35, 445, DateTimeKind.Local).AddTicks(9136),
                            FormatoVenta = "Unidad",
                            IVA = 0.29999999999999999,
                            Marca = "Ferres",
                            PrecioVenta = 5000.0,
