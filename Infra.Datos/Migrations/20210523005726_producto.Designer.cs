...
namespace Infra.Datos.Migrations
{
    ...
    [Migration("20210523005726_producto")]
            ...
            modelBuilder.Entity("Domain.Models.Entities.Empleado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estado = "Activo",
                            FechaIngreso = new DateTime(2021, 5, 22, 19, 57, 24, 883, DateTimeKind.Local).AddTicks(2436),
                            IdEmpleado = 2699540,
            ...
            modelBuilder.Entity("Domain.Models.Entities.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fabrica = "Ferres SAS",
                            FechaRegistro = new DateTime(2021, 5, 22, 19, 57, 24, 879, DateTimeKind.Local).AddTicks(4812),
                            FormatoVenta = "Unidad",
            ...
            modelBuilder.Entity("Domain.Models.Entities.Terceros", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            Extranjero = false,
                            FechaCumple = new DateTime(2021, 5, 22, 19, 57, 24, 883, DateTimeKind.Local).AddTicks(9768),
                        ...
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            Extranjero = false,
                            FechaCumple = new DateTime(2021, 5, 22, 19, 57, 24, 884, DateTimeKind.Local).AddTicks(486),
