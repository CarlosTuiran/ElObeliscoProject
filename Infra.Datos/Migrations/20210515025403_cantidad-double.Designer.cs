...
namespace Infra.Datos.Migrations
{
    ...
    [Migration("20210515025403_cantidad-double")]
            ...
            modelBuilder.Entity("Domain.Models.Entities.Empleado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estado = "Activo",
                            FechaIngreso = new DateTime(2021, 5, 14, 21, 54, 2, 457, DateTimeKind.Local).AddTicks(9163),
                            IdEmpleado = 2699540,
            ...
            modelBuilder.Entity("Domain.Models.Entities.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fabrica = "Ferres SAS",
                            FechaRegistro = new DateTime(2021, 5, 14, 21, 54, 2, 452, DateTimeKind.Local).AddTicks(9466),
                            FormatoVenta = "Unidad",
            ...
            modelBuilder.Entity("Domain.Models.Entities.Terceros", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            FechaCumple = new DateTime(2021, 5, 14, 21, 54, 2, 459, DateTimeKind.Local).AddTicks(211),
                            Nit = "106583",
                        ...
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            FechaCumple = new DateTime(2021, 5, 14, 21, 54, 2, 459, DateTimeKind.Local).AddTicks(1247),
                            Nit = "10653434",
                            Nombre = "Jose Jose",
                            TipoTercero = "Cliente"
                        });
