...
namespace Infra.Datos.Migrations
{
    ...
    [Migration("20210610020003_libroContable2")]
    partial class libroContable2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Entities.Bodega", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Models.Entities.Empleado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estado = "Activo",
                            FechaIngreso = new DateTime(2021, 6, 9, 21, 0, 2, 165, DateTimeKind.Local).AddTicks(5247),
                            IdEmpleado = 2699540,
            ...
            modelBuilder.Entity("Domain.Models.Entities.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fabrica = "Ferres SAS",
                            FechaRegistro = new DateTime(2021, 6, 9, 21, 0, 2, 162, DateTimeKind.Local).AddTicks(8645),
                            FormatoVenta = "Unidad",
                            IdCategoria = 1,
                            IdMarca = 1,
                            IdProveedor = "106583",
            ...
            modelBuilder.Entity("Domain.Models.Entities.Terceros", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            Extranjero = false,
                            FechaCumple = new DateTime(2021, 6, 9, 21, 0, 2, 165, DateTimeKind.Local).AddTicks(9405),
                        ...
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            Extranjero = false,
                            FechaCumple = new DateTime(2021, 6, 9, 21, 0, 2, 165, DateTimeKind.Local).AddTicks(9972),
