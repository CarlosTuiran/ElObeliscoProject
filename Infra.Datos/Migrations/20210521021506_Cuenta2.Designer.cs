...
namespace Infra.Datos.Migrations
{
    ...
    [Migration("20210521021506_Cuenta2")]
    partial class Cuenta2
    {
            ...
            modelBuilder.Entity("Domain.Models.Entities.Empleado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estado = "Activo",
                            FechaIngreso = new DateTime(2021, 5, 20, 21, 15, 5, 948, DateTimeKind.Local).AddTicks(4486),
                            IdEmpleado = 2699540,
            ...
            modelBuilder.Entity("Domain.Models.Entities.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fabrica = "Ferres SAS",
                            FechaRegistro = new DateTime(2021, 5, 20, 21, 15, 5, 945, DateTimeKind.Local).AddTicks(2426),
                            FormatoVenta = "Unidad",
            ...
            modelBuilder.Entity("Domain.Models.Entities.Terceros", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            Extranjero = false,
                            FechaCumple = new DateTime(2021, 5, 20, 21, 15, 5, 949, DateTimeKind.Local).AddTicks(2099),
                        ...
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            Extranjero = false,
                            FechaCumple = new DateTime(2021, 5, 20, 21, 15, 5, 949, DateTimeKind.Local).AddTicks(2858),
