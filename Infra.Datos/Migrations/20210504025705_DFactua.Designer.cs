...
namespace Infra.Datos.Migrations
{
    ...
    [Migration("20210504025705_DFactua")]
    partial class DFactua
    {
            ...
            modelBuilder.Entity("Domain.Models.Entities.Empleado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estado = "Activo",
                            FechaIngreso = new DateTime(2021, 5, 3, 21, 57, 3, 690, DateTimeKind.Local).AddTicks(557),
                            IdEmpleado = 2699540,
            ...
            modelBuilder.Entity("Domain.Models.Entities.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fabrica = "Ferres SAS",
                            FechaRegistro = new DateTime(2021, 5, 3, 21, 57, 3, 682, DateTimeKind.Local).AddTicks(4826),
                            FormatoVenta = "Unidad",
            ...
            modelBuilder.Entity("Domain.Models.Entities.Terceros", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            FechaCumple = new DateTime(2021, 5, 3, 21, 57, 3, 690, DateTimeKind.Local).AddTicks(9808),
                            Nit = "106583",
                        ...
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            FechaCumple = new DateTime(2021, 5, 3, 21, 57, 3, 691, DateTimeKind.Local).AddTicks(737),
                            Nit = "10653434",
                            Nombre = "Jose Jose",
                            TipoTercero = "Cliente"
                        });
