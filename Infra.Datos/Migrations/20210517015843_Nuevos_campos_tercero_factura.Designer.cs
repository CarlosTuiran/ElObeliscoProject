...
namespace Infra.Datos.Migrations
{
    ...
    [Migration("20210517015843_Nuevos_campos_tercero_factura")]
    partial class Nuevos_campos_tercero_factura
    {
            ...
            modelBuilder.Entity("Domain.Models.Entities.Empleado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estado = "Activo",
                            FechaIngreso = new DateTime(2021, 5, 16, 20, 58, 41, 701, DateTimeKind.Local).AddTicks(7768),
                            IdEmpleado = 2699540,
            ...
            modelBuilder.Entity("Domain.Models.Entities.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fabrica = "Ferres SAS",
                            FechaRegistro = new DateTime(2021, 5, 16, 20, 58, 41, 690, DateTimeKind.Local).AddTicks(8415),
                            FormatoVenta = "Unidad",
            ...
            modelBuilder.Entity("Domain.Models.Entities.Terceros", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            FechaCumple = new DateTime(2021, 5, 16, 20, 58, 41, 703, DateTimeKind.Local).AddTicks(3983),
                            Nit = "106583",
                        ...
                        new
                        {
                            ...
                            Direccion = "Stranger Valley",
                            FechaCumple = new DateTime(2021, 5, 16, 20, 58, 41, 703, DateTimeKind.Local).AddTicks(5530),
                            Nit = "10653434",
                            Nombre = "Jose Jose",
                            TipoTercero = "Cliente"
                        });
